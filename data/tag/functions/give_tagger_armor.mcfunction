...
item modify entity @s armor.head tag:tagger
item modify entity @s armor.chest tag:tagger
item modify entity @s armor.legs tag:tagger
item modify entity @s armor.feet tag:tagger
